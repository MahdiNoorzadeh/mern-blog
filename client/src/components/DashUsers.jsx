    ...
    <div className="table-auto overflow-x-scroll md:mx-auto p-3 scrollbar scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500">
     {currentUser.isAdmin && users.length > 0 ? (
      ...
      <Table hoverable className="shadow-md">
        <Table.Head>
          <Table.HeadCell>تاریخ عضویت</Table.HeadCell>
          <Table.HeadCell>عکس کاربر</Table.HeadCell>
          <Table.HeadCell>نام کاربری</Table.HeadCell>
          <Table.HeadCell>ایمیل کاربری</Table.HeadCell>
          ...
          <Table.Body className="divide-y" key={user._id}>
            <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell>
                  ...
                  alt={user.username}
                  className="w-10 h10 object-cover bg-gray-500 rounded-full"
                  />
              ...
              <Table.Cell>{user.isAdmin ? <FaCheck className='text-green-500'/> : <FaTimes className='text- bg-red-500'/>}</Table.Cell>
            <Table.Cell>
              <span onClick={() => {
                setShowModal(true)
        ...
        <Modal.Body>
            <div className="text-center">
                ...
                <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>
                    مطمئن هستید که میخواهید کاربر را حذف کنید؟
                </h3>
