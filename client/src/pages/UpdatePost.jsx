  ...
  return (
        ...
        <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-4 sm:flex-row justify-between">
                <TextInput type="text" placeholder="عنوان" required id='title' className="flex-1" onChange={(e) => setFormData({...formData, title: e.target.value})} value={formData.title}/>
                <Select
                    onChange={(e) =>
            ...
            <ReactQuill theme="snow" value={formData.content} placeholder="نوشتن را شروع کنید" className="h-72 mb-12" required onChange={(value) => {
