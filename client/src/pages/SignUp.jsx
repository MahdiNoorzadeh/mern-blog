  ...
  const handleChange = (e) => {
    ...
    const hadnleSubmit = async (e) => {
      ...
      if (!formData.username || !formData.email || !formData.password){
        return setErrorMessage('لطفا تمامی فیلد ها پر کنید!')
      }
      try {
        setLoading(true)
    ...
    Mahdi&#39;s
        ...
        <form className="flex flex-col gap-4" onSubmit={hadnleSubmit}>
          <div>
            ...
            <TextInput type="text" placeholder="نام کابری" id="username" onChange={handleChange}/>
          </div>
          <div>
          ...
          <div>
            ...
            <TextInput type="password" placeholder="رمز عبور کابری" id="password" onChange={handleChange}/>
          </div>
